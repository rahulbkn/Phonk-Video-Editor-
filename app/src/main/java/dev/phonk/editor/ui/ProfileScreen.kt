...
/**
 * Profile screen — app info, quick stats and an About dialog. Uses the shared
 * dark design system + floating bottom navigation so it matches Home,
 * Templates and Projects exactly.
 */
@Composable
fun ProfileScreen(
    onBack: () -> Unit,
        ...
        Column(Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                Column(
                    modifier = Modifier
                        .fillMaxWidth()
                        .background(palette.card, RoundedCornerShape(UiDimens.homeCardCorner))
                ...
                TextButton(
                    ...
                    Text(
                        stringResource(R.string.profile_about_button),
